/* project duo - Read the electricity meter in SZDIY Hackspace and send data to szdiy.org
 *
 * Adapted from the http_get_mbedtls example in esp-open-rtos
 *
...
#define WEB_SERVER "szdiy.org"
#define WEB_PORT "443"
// The URL format looks something like this:
//#define WEB_URL "https://api.szdiy.org/duo/upload?node=001&total=3988.00&time=1231029318"
#define WEB_URL "https://api.szdiy.org/duo"
//#define WEB_URL "https://szdiy.org"
